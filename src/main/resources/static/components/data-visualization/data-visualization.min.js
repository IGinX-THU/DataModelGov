...
class DataVisualization extends HTMLElement {
    ...
    updateChart() {
        ...
        const hasTimeColumn = this.tableHeader && this.tableHeader.includes('Time'); // 直接判断表头是否有Time列
