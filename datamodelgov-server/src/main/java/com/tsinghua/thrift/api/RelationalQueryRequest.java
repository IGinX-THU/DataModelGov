            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filters = new java.util.ArrayList<FilterCondition>(_list16.size);
                @org.apache.thrift.annotation.Nullable FilterCondition _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new FilterCondition();
                  _elem17.read(iprot);
                  struct.filters.add(_elem17);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.filters != null) {
        if (struct.isSetFilters()) {
          oprot.writeFieldBegin(FILTERS_FIELD_DESC);
          {
            ...
            for (FilterCondition _iter19 : struct.filters)
            {
              _iter19.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (FilterCondition _iter20 : struct.filters)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.filters = new java.util.ArrayList<FilterCondition>(_list21.size);
          @org.apache.thrift.annotation.Nullable FilterCondition _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new FilterCondition();
            _elem22.read(iprot);
            struct.filters.add(_elem22);
          }
        }
        struct.setFiltersIsSet(true);
      }
