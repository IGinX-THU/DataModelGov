    ...
    async handleUpload() {
        ...
        if (sourceType === 'preset') {
            ...
            try {
                ...
                const url = window.AppConfig.getApiUrl('program', 'preset-programs') + '/' + encodeURIComponent(programId) + '/upload?version=' + encodeURIComponent(version) + '&name=' + encodeURIComponent(name) + '&description=' + encodeURIComponent(descriptionInput ? descriptionInput.value.trim() : '');
