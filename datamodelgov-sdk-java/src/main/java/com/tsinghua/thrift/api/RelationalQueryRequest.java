            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filters = new java.util.ArrayList<FilterCondition>(_list24.size);
                @org.apache.thrift.annotation.Nullable FilterCondition _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new FilterCondition();
                  _elem25.read(iprot);
      ...
      if (struct.filters != null) {
        if (struct.isSetFilters()) {
          oprot.writeFieldBegin(FILTERS_FIELD_DESC);
          {
            ...
            for (FilterCondition _iter27 : struct.filters)
            {
              _iter27.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (FilterCondition _iter28 : struct.filters)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.filters = new java.util.ArrayList<FilterCondition>(_list29.size);
          @org.apache.thrift.annotation.Nullable FilterCondition _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new FilterCondition();
            _elem30.read(iprot);
